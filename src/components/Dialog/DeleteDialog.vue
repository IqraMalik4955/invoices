        ...
        <v-card class="delete-dialog">
            ...
            <v-card-text style="padding-bottom: 15px;">
                ...
                <p v-if="fromComponent !== 'card'">
                    ...
                    <!-- {{ fromComponent }} ‘‘{{ editedItem !== null && editedItem.name !== null ? editedItem.name : '' }}’’? -->
                </p>

                <p v-else>
                    Do you want to delete the 
                 <!-- {{ fromComponent }} ‘‘{{ editedItem !== null && editedItem.name !== null ? editedItem.card_number : '' }}’’ from the payment methods? -->
                </p>
            </v-card-text>
...
export default {
    name: 'DeleteDialog',
    props: ['dialogDelete', 'loadingDelete'],
    mounted() {
    },
    updated() {
    },
