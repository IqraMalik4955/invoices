            ...
            <v-card-text class="mb-0">
                <div class="view-wrapper">
                    ...
                    <div class="view-box-info">
                        ...
                        <p class="item-price">${{ editedItem.unit_price !== null ? parseFloat(editedItem.unit_price).toFixed(2) : 0 }}</p>
                ...
                <div class="product-description-wrapper">
                    ...
                    <div class="view-box-other-data">
                        <div class="item-info classification">
                            ...
                            <!-- <p class="item-data">
                                <span v-if="editedItem.classification_code == ''">--</span>

                                <span v-else>
                                    <span class="code-item" v-for="(item, index) in editedItem.classification_code" :key="index"> 
                                        {{ item }}
                                    </span>
                                </span>
                            </p> -->
                            ...
                            <p class="item-data">
                                {{ (editedItem.classification_code !== null) ? editedItem.classification_code : '--' }}
                            </p>
                        </div>
                        ...
                        <div class="item-info classification">
                            ...
                            <p class="item-data">
                                {{ (editedItem.additional_classification_code !== null) ? editedItem.additional_classification_code : '--' }}
                            </p>
                        </div>
