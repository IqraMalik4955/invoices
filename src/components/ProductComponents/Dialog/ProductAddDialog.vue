<template>
    <v-dialog v-model="dialogAdd" max-width="980px" content-class="product-dialog" :retain-focus="false" @click:outside="close">
        <v-card class="product-dialog-card">
            <v-form ref="form" v-model="valid" action="#" @submit.prevent="">
                    ...
                    <div class="add-wrapper">
                        <div class="product-info">
                            <div class="product-number mb-2">
                                ...
                                <v-radio-group v-model="isCustom" mandatory v-if="editedIndex === -1" hide-details="auto">
                            ...
                            <div class="product-customs-duty">
                                ...
                                <div class="inputs-container country-info">
                                    <div class="classification-code">
                                        ...
                                        <!-- <vue-tags-input
                                            v-model="tag"
                                            placeholder="Enter classification codes"
                                            :tags="tags"
                                            allow-edit-tags
                                            :add-on-blur="true"
                                            :add-on-key="[13, ',']"
                                ...
                                <div class="classification-info-default">
                                    <p class="classification-info mt-1" v-if="productItem.userClassification !== 1 &&  !productItem.userClassification">
                ...
                <v-card-actions class="product-actions">
                    <button class="btn-blue" @click.stop="saveProduct" :disabled="loadingOnce || loadingAndAddAnother">               
                    ...
                    <button class="btn-white" @click.stop="saveAndAddProduct" :disabled="loadingOnce || loadingAndAddAnother">
                        <span v-if="editedIndex === -1">
...
export default {
    ...
    methods: {
        ...
        async saveProduct() {
            ...
            // else {
            //     if (this.tags !== 'undefined' && Array.isArray(this.tags) && this.tags.length > 0) {                    
            //         this.tags.map(v => {
            //             finalClassificationCodes.push(v.text)
            //         })

            //         classification_code = finalClassificationCodes.length > 0 ? JSON.stringify(finalClassificationCodes) : ''
            //     }
            // }
    ...
    watch: {
        ...
        //             if (this.productItem.classification_code !== '' && this.productItem.classification_code !== null &&
        //                 Array.isArray(this.productItem.classification_code) && this.productItem.classification_code.length > 0) {
        //                 this.productItem.classification_code.map((wea, index) => {
        //                     if (wea!==null) {
        //                         validEmailAddress.push({id: `id-${index}-${wea}`, text: wea, tiClasses:["ti-valid"]})
        //                     }
        //                 })
        //             }

        //             this.tags = validEmailAddress    
        //         }                
        //     }
        // }
    },
