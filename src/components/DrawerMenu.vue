<template>
    <div class="sidebar">
        ...
        <ul class="links">
            ...
            <li>
                <router-link to="/shipments" v-bind:class="{'active-link': ($store.state.page.currentPage=='shipments')}">
            ...
            <li>
                <router-link to="/products" v-bind:class="{'active-link': ($store.state.page.currentPage=='products')}">
            ...
            <li>
                <router-link to="/suppliers" v-bind:class="{'active-link': ($store.state.page.currentPage=='suppliers')}">
            ...
            <v-list dark>
                ...
                >
                    ...
                    <li>
                        <router-link class="pl-15" to="/invoices" v-bind:class="{'active-link': ($store.state.page.currentPage=='invoices')}">
                            Invoices
                        </router-link>
                    </li>
                </v-list-group>
    ...
    <div v-if="isMobile" style="height:2px; background-color: #039DDC; margin: 12px"></div>
            ...
            <li v-if="isMobile" style="padding: 0 16px; color: #E1ECF0 !important; display: flex; align-items: center; cursor: pointer;">
                <v-avatar size="35" style="margin-right: 10px">
                    <v-icon small class="mr-2 account" > mdi-account </v-icon>
                </v-avatar>
